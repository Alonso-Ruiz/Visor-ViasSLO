var size = 0;
var placement = 'point';
var fill_PlantasdeAlamedasypasajes_1 = new ol.style.Fill({color: 'rgba(184,226,62,0.5019607843137255)'});
function categories_PlantasdeAlamedasypasajes_1(feature, value, size, resolution, labelText,
...
case 'Servidumbre de Paso':
        ...
        fill: fill_PlantasdeAlamedasypasajes_1,
        text: createTextStyle(feature, resolution, labelText, labelFont,
                              labelFill, placement, bufferColor,
                              bufferWidth)
    }),new ol.style.Style({
...
var style_PlantasdeAlamedasypasajes_1 = function(feature, resolution){
    var context = {
        feature: feature,
        variables: {}
    };
    ...
    var style = categories_PlantasdeAlamedasypasajes_1(feature, value, size, resolution, labelText,
