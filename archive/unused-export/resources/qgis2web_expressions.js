...
function exp_jerarqua_vial_1rule0_eval_expression(context) {
    // NIVEL  IN ('ARTERIALES', 'COLECTORAS', 'EXPRESA METROPOLITANA', 'EXPRESA NACIONAL-REGIONAL')

    var feature = context.feature;
    
    if (feature.properties) {
        return "'ARTERIALES', 'COLECTORAS', 'EXPRESA METROPOLITANA', 'EXPRESA NACIONAL-REGIONAL'".indexOf(feature.get('NIVEL') ) > -1 ;
    } else {
        return "'ARTERIALES', 'COLECTORAS', 'EXPRESA METROPOLITANA', 'EXPRESA NACIONAL-REGIONAL'".indexOf(feature.get('NIVEL') ) > -1 ;
    }
}
...
function exp_label_red_vial_2_eval_expression(context) {
    // NOMBRECOMP

    var feature = context.feature;
    
    if (feature.properties) {
        return feature.get('NOMBRECOMP') ;
    } else {
        return feature.get('NOMBRECOMP') ;
    }
}